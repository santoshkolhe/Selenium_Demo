...
public class Weborder_CreateOrder_VerifyOrder_DeleteOrder_VerifyDeleteOrder {
	WebDriver driver;
	String ExpName;
	...
	public void CreateOrder_VerifyOrder() throws InterruptedException {
		...
		Thread.sleep(3000);
		// String ActOutputname =
		// driver.findElement(By.xpath("//td[normalize-space()='Dixit']")).getText();
	...
	public void UpdateOrder_VerifyUpdateOrder() throws InterruptedException {
		...
		String ActCity = driver
				.findElement(By.xpath("//td[normalize-space()='" + ExpName + "']//following-sibling::td[5]")).getText();
	...
	@Test(priority = 4)
	public void DeleteOrder_VerifyDeleteOrder() throws InterruptedException {

		driver.findElement(By.xpath("//td[normalize-space()='" + ExpName + "']//preceding-sibling::td/input")).click();
		driver.findElement(By.id("ctl00_MainContent_btnDelete")).click();
		//verify that user got deleted.
        Boolean actVal=driver.getPageSource().contains(ExpName);
        Assert.assertFalse(actVal);
	}
